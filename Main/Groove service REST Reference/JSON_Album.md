...
| ImageUrl          | String                                                               | A direct link to the default image associated with this piece of content. See [Image Service](../Using the Groove RESTful Services/Image Service.ùd) for more information on how these links may be customized to produce different images.                                                                                                                                                                                                                                          |
