...
| browseType        | string                | Required. The type of the parent element ([Album](JSON_Album.htm), [Artist](JSON_Artist.htm) or [Playlist](JSON_Playlist.md)).                     |
...
[/1/content/{id}/{source}/{browseType}/{extra}/browse](URI_ContentIdSourceBrowsetypeExtraBrowse.htm)
